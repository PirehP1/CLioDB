# -*- coding: utf-8 -*-
"""
.. module:: HierarchicalHeaderView
   :synopsis: Module pour la gestion des tableaux avec colonnes hiérarchiques
...
class private_data:
    ...
    def cellSize(self,leafIndex, hv, styleOptions):
        ...
        size = QtCore.QSize(fm.size(0, unicode(leafIndex.data(QtCore.Qt.DisplayRole))))
    ...
    def paintHorizontalCell(self, painter, hv, cellIndex, leafIndex, logicalLeafIndex, styleOptions, sectionRect, top):
        ...
        uniopt.text = unicode(cellIndex.data(QtCore.Qt.DisplayRole))
        painter.save()
        uniopt.rect = r;
...
class HierarchicalHeaderView(QtGui.QHeaderView):
  ...
  def sectionSizeFromContents(self,logicalIndex):
    ...
    si = QtGui.QHeaderView.sectionSizeFromContents(self,logicalIndex)
    #si.setHeight(12)    
    return si
